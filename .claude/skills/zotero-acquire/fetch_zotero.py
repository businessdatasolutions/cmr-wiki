...
Usage:
    python fetch_zotero.py --collection cmr-wiki
    python fetch_zotero.py --collection "State of AI" --dry-run
    python fetch_zotero.py -c cmr-wiki --limit 3 --json
...
def main() -> int:
    ...
    ap.add_argument("-c", "--collection", default="cmr-wiki", help="Zotero collection name (default: cmr-wiki)")
